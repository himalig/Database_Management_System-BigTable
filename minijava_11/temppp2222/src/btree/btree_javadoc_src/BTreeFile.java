...
public class BTreeFile extends IndexFile
    ...
    private void _destroyFile(PageId pageno)
        ...
        if (sortedPage.getinsertType() == NodeType.INDEX) {
    ...
    private KeyDataEntry _insert(KeyClass key, MID mid,
        ...
        if (currentPage.getinsertType() == NodeType.INDEX) {
        ...
        } else if (currentPage.getinsertType() == NodeType.LEAF) {
    ...
    BTLeafPage findRunStart(KeyClass lo_key,
        ...
        while (sortPage.getinsertType() == NodeType.INDEX) {
    ...
    private KeyClass _Delete(KeyClass key,
        ...
        if (sortPage.getinsertType() == NodeType.LEAF) {
            MID curRid = new MID();  // iterator
            KeyDataEntry tmpEntry;
            KeyClass curkey;
            MID dummyRid;
        ...
        if (sortPage.getinsertType() == NodeType.INDEX) {
            PageId childPageId;
            BTIndexPage indexPage = new BTIndexPage(page, headerPage.get_keyType());
    ...
    void trace_children(PageId id)
        ...
        if (trace != null) {
            ...
            } else if (sortedPage.getinsertType() == NodeType.LEAF) {
