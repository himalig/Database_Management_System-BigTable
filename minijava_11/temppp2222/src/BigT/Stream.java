...
public class Stream {
        ...
        try {
            switch (indexType) {
                case 1:
                    ...
                    break;
                default:
                    mapIterator = new ScanMap(bigtName,indexType, condExprs, index_2_filter, index_3_filter, index_4_filter, index_5_filter);
                    break;
            }
    ...
    public static CondExpr[] getKeyFilterForIndexType(int orderType, String rowFilter, String columnFilter, String valueFilter) {
        ...
        result[i] = null;
//        System.out.println("results in key-=="+result+"results  len  in key-=="+result.length);
        return result;
    }
