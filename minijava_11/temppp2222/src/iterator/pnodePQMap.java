...
public abstract class pnodePQMap {
    ...
    public int pnodeCMP(pnodeMap a, pnodeMap b)
        ...
        switch(order_type) {
            case 1:
                ans = MapUtils.compareMapWithMap_one(a.map, b.map);
                break;
            case 2:
                ans = MapUtils.compareMapWithMap_two(a.map, b.map);
                break;
            case 3:
                ans = MapUtils.compareMapWithMap_three(a.map, b.map);
                break;
            case 4:
                ans = MapUtils.compareMapWithMap_four(a.map, b.map);
                break;
            case 5:
                ans = MapUtils.compareMapWithMap_five(a.map, b.map);
                break;
            case 6:
                ans = MapUtils.compareMapWithMap_six(a.map, b.map);
                break;
            case 7:
                ans = MapUtils.CompareMapWithMapValues(a.map, b.map);
                break;
            case 9:
                ans = MapUtils.compareMapWithMap_seven(a.map, b.map);
                break;
        }
        return ans;
    }
