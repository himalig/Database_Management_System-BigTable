...
public class MapUtils {
     ...
     * @throws IOException                    some I/O fault
     */
    public static int compareMapWithMap_two(Map m1, Map m2) throws IOException {
        int colComp = m1.getColumnLabel().compareTo(m2.getColumnLabel());
        if(colComp == 0) {
            int rowComp = m1.getRowLabel().compareTo(m2.getRowLabel());
            if(rowComp == 0) {
     ...
     * @throws IOException                    some I/O fault
     */
    public static int compareMapWithMap_three(Map m1, Map m2) throws IOException {
        int rowComp = m1.getRowLabel().compareTo(m2.getRowLabel());
        if(rowComp == 0) {
            return compareMapWithMap_five(m1, m2);
        } else {
    ...
    public static int compareMapWithMap_seven(Map m1, Map m2) throws IOException {
    	int rowComp=m1.getRowLabel().compareTo(m2.getRowLabel());   
        if(rowComp == 0) {
            return  m1.getColumnLabel().compareTo(m2.getColumnLabel());
     ...
     * @throws IOException                    some I/O fault
     */
    public static int compareMapWithMap_four(Map m1, Map m2) throws IOException {
        int colComp = m1.getColumnLabel().compareTo(m2.getColumnLabel());
        if(colComp == 0) {
            return compareMapWithMap_five(m1, m2);
        } else {
     ...
     * @throws IOException                    some I/O fault
     */
    public static int compareMapWithMap_five(Map m1, Map m2) throws IOException {
        if (m1.getTimeStamp() > m2.getTimeStamp()) {
            return 1;
        } else if (m1.getTimeStamp() < m2.getTimeStamp()) {
            return -1;
    ...
    public static int compareMapWithMap_six(Map m1, Map m2) throws IOException{
        int rowComp = m1.getRowLabel().compareTo(m2.getRowLabel());
        if(rowComp == 0) {
            return m1.getValue().compareTo(m2.getValue());
        } else {
    ...
    public static int CompareMapWithMapRows(Map m1, Map m2) throws IOException{
    	return  m1.getRowLabel().compareTo(m2.getRowLabel());
    }
